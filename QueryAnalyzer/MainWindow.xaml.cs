...
//                            {
//                                // Usamos SortMemberPath porque Header puede tener los guiones bajos
//                                // reemplazados por espacios cuando el DataGrid los genera automáticamente
//                                string colName = (column as DataGridBoundColumn)?.SortMemberPath
//                                                ?? column.Header?.ToString()
//                                                ?? string.Empty;
//                                if (!dt.Columns.Contains(colName))
//                                    continue;

//                                // Restaurar el header con el nombre real de la columna (preserva guiones bajos)
