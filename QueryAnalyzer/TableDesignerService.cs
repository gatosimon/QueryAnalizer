    ...
    public static class TableDesignerService
    {
        ...
        private static List<ColumnDesignInfo> GetColumnasDesign(Conexion conexion, string tabla)
        {
            ...
            try
            {
                ...
                resultado = BuildColumnsFromDB(connStr, conexion.Motor, nombreTabla);
            }
            catch (Exception ex)
            {
        ...
        private static List<ColumnDesignInfo> BuildColumnsFromDB(string connStr, TipoMotor motor, string tabla)
        {
                ...
                case TipoMotor.MS_SQL:
                    {
                        ...
                        try
                        {
                            ...
                            DB.CommandText = sqlDesc;
                            while (DB.Read())
                            {
                                string colName = DB.Reader[0].ToString().Trim();
                                string desc = DB.IsDBNull(1) ? null : DB.Reader[1].ToString().Trim();
                        ...
                        while (DB.Read())
                        {
                            ...
                            var col = new ColumnDesignInfo
                            {
                                ...
                                Longitud = DB.IsDBNull(2) ? (int?)null : Convert.ToInt32(DB.Reader[2]),
                                Precision = DB.IsDBNull(3) ? (int?)null : Convert.ToInt32(DB.Reader[3]),
                                Escala = DB.IsDBNull(4) ? (int?)null : Convert.ToInt32(DB.Reader[4]),
                                EsNulable = DB.Reader[5].ToString().Trim().ToUpperInvariant() == "YES",
                                ValorDefault = DB.IsDBNull(6) ? null : DB.Reader[6].ToString().Trim(),
                                EsPK = Convert.ToInt32(DB.Reader[7]) == 1,
                ...
                case TipoMotor.DB2:
                    {
                        ...
                        while (DB.Read())
                        {
                            ...
                            int scale = DB.IsDBNull(3) ? 0 : Convert.ToInt32(DB.Reader[3]);
                            bool isPK = !DB.IsDBNull(6) && Convert.ToInt32(DB.Reader[6]) > 0;
                            var col = new ColumnDesignInfo
                            {
                                ...
                                EsNulable = DB.Reader[4].ToString().Trim().ToUpperInvariant() == "Y",
                                ValorDefault = DB.Reader.IsDBNull(5) ? null : DB.Reader[5].ToString().Trim(),
                                EsPK = isPK,
                                Descripcion = DB.IsDBNull(7) ? null : DB.Reader[7].ToString().Trim()
                            };
                            col.MarcarComoOriginal();
                            lista.Add(col);
                        }
                ...
                case TipoMotor.POSTGRES:
                    {
                        ...
                        while (DB.Read())
                        {
                            var col = new ColumnDesignInfo
                            {
                                ...
                                ValorDefault = DB.IsDBNull(6) ? null : DB.Reader[6].ToString().Trim(),
                                EsPK = Convert.ToInt32(DB.Reader[7]) == 1,
                                Descripcion = DB.IsDBNull(8) ? null : DB.Reader[8].ToString().Trim()
                            };
                            col.MarcarComoOriginal();
                            lista.Add(col);
                        }
                ...
                case TipoMotor.SQLite:
                    {
                        ...
                        while (DB.Read())
                        {
                            ...
                            var col = new ColumnDesignInfo
                            {
                                ...
                                TipoDato = tipoDato,
                                Longitud = longitud,
                                EsNulable = DB.Reader[3].ToString().Trim() == "0", // notnull=0 → nullable
                                ValorDefault = DB.IsDBNull(4) ? null : DB.Reader[4].ToString().Trim(),
